...
const PageHeader = () => (
    <div className="relative h-64 bg-sg-purple flex items-center justify-center text-white text-center">
        ...
        <div className="relative z-10">
            <h1 className="text-5xl font-serif font-bold">Upcoming Events</h1>
            <p className="text-xl mt-2">Get involved in our church life.</p>
        </div>
    </div>
);
...
const EventCard: React.FC<{ event: Event }> = ({ event }) => (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row transform hover:-translate-y-2 transition-transform duration-300">
        ...
        <div className="p-6 flex flex-col justify-between">
            <div>
                <h3 className="text-2xl font-serif font-bold text-sg-purple mb-2">{event.title}</h3>
