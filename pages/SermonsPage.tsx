...
const PageHeader = () => (
    <div className="relative h-56 sm:h-64 bg-sg-purple flex items-center justify-center text-white text-center p-4">
        ...
        <div className="relative z-10">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-bold">Livestream & Sermons</h1>
            <p className="text-base sm:text-lg lg:text-xl mt-2">Catch up on the latest messages.</p>
        </div>
    </div>
);
...
const LivestreamPlayer: React.FC = () => (
    <section className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-6">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-center text-sg-purple mb-8">Watch Us Live</h2>
...
const PastSermons: React.FC = () => (
    <section className="py-16 sm:py-20 bg-sg-light">
        <div className="container mx-auto px-6">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-center text-sg-purple mb-12">Sermon Archive</h2>
