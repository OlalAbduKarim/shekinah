...
const NewsletterPopup: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4 font-sans">
      <div className="bg-white rounded-lg shadow-2xl p-8 max-w-md w-full relative transform transition-all scale-100 opacity-100 animate-fade-in">
        ...
        {isSubmitted ? (
            <div className="text-center">
                <h3 className="text-2xl font-bold font-serif text-sg-purple mb-2">Thank You!</h3>
                <p className="text-gray-600">You've been successfully subscribed to our newsletter.</p>
            </div>
        ) : (
            <>
                <h3 className="text-2xl font-bold font-serif text-sg-purple mb-2">Stay Connected</h3>
                <p className="text-gray-600 mb-6">Join our mailing list to receive weekly encouragement, event updates, and inspirational content right in your inbox.</p>
                <form onSubmit={handleSubmit}>
                    <input 
                        ...
                        required
                        className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-sg-gold focus:border-sg-gold outline-none"
                    />
