...
const Hero: React.FC = () => (
    <div className="relative h-screen min-h-[500px] text-white flex items-center justify-center text-center">
        ...
        <div className="relative z-10 p-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                <Link to="/about" className="bg-sg-gold text-sg-purple font-bold py-3 px-8 rounded-full hover:bg-yellow-300 text-lg w-full sm:w-auto">
                    New Here?
                </Link>
                <Link to="/sermons" className="border-2 border-white text-white font-bold py-3 px-8 rounded-full hover:bg-white hover:text-black transition-all duration-300 text-lg w-full sm:w-auto">
                    Watch Live
                </Link>
            </div>
        </div>
...
const ServiceTimes: React.FC = () => (
    <div className="bg-sg-purple text-white py-12 sm:py-16">
        <div className="container mx-auto px-6 text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-sg-gold mb-8">Join Us for Worship</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                <div className="p-6">
                    <h3 className="text-xl sm:text-2xl font-bold font-serif">Sunday Worship</h3>
                    <p className="text-lg sm:text-xl text-gray-300">10:00 AM</p>
                </div>
                <div className="p-6 border-t-2 border-b-2 md:border-t-0 md:border-b-0 md:border-l-2 md:border-r-2 border-sg-gold">
                    <h3 className="text-xl sm:text-2xl font-bold font-serif">Wednesday Bible Study</h3>
                    <p className="text-lg sm:text-xl text-gray-300">7:00 PM</p>
                </div>
                <div className="p-6">
                    <h3 className="text-xl sm:text-2xl font-bold font-serif">Friday Prayer</h3>
                    <p className="text-lg sm:text-xl text-gray-300">8:00 PM</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <section className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-sg-purple mb-4">A Warm Welcome Awaits You</h2>
...
const LatestSermons: React.FC = () => (
    <section className="py-16 sm:py-20 bg-sg-light">
        <div className="container mx-auto px-6 text-center">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-sg-purple mb-12">Latest Messages</h2>
                ...
                {MOCK_SERMONS.slice(0, 2).map((sermon) => (
                    <div key={sermon.title} className="bg-white rounded-lg shadow-lg overflow-hidden text-left transform hover:-translate-y-2 transition-transform duration-300">
                        <div className="aspect-video bg-black">
                           <iframe className="w-full h-full" src={`https://www.youtube.com/embed/${sermon.videoId}`} title={sermon.title} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        </div>
                        <div className="p-6">
